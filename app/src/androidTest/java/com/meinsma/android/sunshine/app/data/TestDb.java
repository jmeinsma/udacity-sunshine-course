 ...
 */
package com.meinsma.android.sunshine.app.data;
...
import com.meinsma.android.sunshine.app.data.WeatherContract.LocationEntry;
import com.meinsma.android.sunshine.app.data.WeatherContract.WeatherEntry;
...
public class TestDb extends AndroidTestCase {
    ...
    void deleteTheDatabase() {
        mContext.deleteDatabase(com.meinsma.android.sunshine.app.data.WeatherDbHelper.DATABASE_NAME);
    }
    ...
    */
    public void testLocationTable() {
        ...
        long locationRowId = insertLocation(db, LocationEntry.TABLE_NAME, TestUtilities.createNorthPoleLocationValues());
    ...
    public void testWeatherTable() {
        ...
        long locationRowId = insertLocation(db, LocationEntry.TABLE_NAME, locationValues);
        assertTrue(locationRowId != -1);

        ContentValues weatherValues = TestUtilities.createWeatherValues(locationRowId);
        long weatherRowId = insertLocation(db, WeatherEntry.TABLE_NAME, weatherValues);
     ...
     */
    public long insertLocation(SQLiteDatabase db, String tableName, ContentValues values) {
